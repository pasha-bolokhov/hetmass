...
with twisted
masses $ m^l $ ($\, l = 1, ...\, N $) is given by the strong coupling ($ e^2\to \infty $) limit  of
...
\eeq
while $x_k$ ($k=0,3$) denotes two coordinates
...
\marginpar{\tiny postavil pravayu skobku 
\\
v (2.1),
poslednyaya stroka}

A comment is in order here on our summation conventions for the CP($N-1$) indices $l$, {\it etc.}, since
	it becomes non-trivial once the twisted masses are introduced.
